...
def is_palindrome(value):
    value=value.replace(" ","") #para un parametro con espacio
...
class TestPalindrome(unittest.TestCase):
    ...
    def test_espacio(self):
         resultado=is_palindrome('t esti ng gn itse t')
         self.assertEqual(resultado,True)
    def test_espacio2(self):
         resultado=is_palindrome('t e s ting gnsfsdfs')
         self.assertEqual(resultado,False)
